...
namespace YEONJI.Kindergarten
{
    public static class PathFinder
    {
        ...
        public static List<Vector2Int> FindPath(GridManager map, Vector2Int start, Vector2Int goal, HashSet<Vector2Int> occupied = null)
        {
            ...
            while (open.Count > 0)
            {
                ...
                foreach (var dir in dirs)
                {
                    ...
                    // 4. 다른 유치원생이 있는 칸
                    // 5. 입구칸
                    if (!map.CanEnter(current.pos, next)) continue;
        ...
        private static List<Vector2Int> Reconstruct(Node goalNode)
        {
