...
public class KidAgent : MonoBehaviour
{
    ...
    public void BeginSegment()
    {
        ...
        segEnd = GridMap.instance.GridToWorld(cell.x, cell.y);
    ...
    public void Tick(float dt)
    {
        ...
        else
        {
            ...
            var curZone = GridMap.instance.GetCell(CurrentCell.x, CurrentCell.y).zone;
            var nextZone = GridMap.instance.GetCell(nextCell.x, nextCell.y).zone;
    ...
    {
        var newPath = PathManager.instance.FindPath(CurrentCell, des, occupied);
